...
public class DataSQL {
    ...
    private boolean createPlayerManagerTable(DbStatement stm) {
        String player_manager = "CREATE TABLE playersdata ("
                ...
                + "unrankedPlayed INT(64) DEFAULT '0',"
                + "unrankedWin INT(64) DEFAULT '0',"
                + "rankedPlayed INT(64) DEFAULT '0',"
                + "rankedWin INT(64) DEFAULT '0',"
                + "lastLadder VARCHAR(255) DEFAULT 'Never Played',"
                + "lastRanked VARCHAR(16) DEFAULT 'false',"
                + "longerHits INT(64) DEFAULT '0',"
                + "missedPot INT(64) DEFAULT '0',"
                + "lastOpponent VARCHAR(16) DEFAULT 'None',"
