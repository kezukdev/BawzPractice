...
public class Arena {
    ...
    public Arena(final String name, final ArenaType arenaType, final Location loc1, final Location middle, final Location loc2) {
        this.name = name;
        this.arenaType = arenaType;
        this.loc1 = loc1;
        this.middle = middle;
        this.loc2 = loc2;
        Practice.getInstance().getRegisterCollections().getArena().add(this);
    }
    
    public Arena(final String name, final ArenaType arenaType) {
    ...
    public static Arena getArena(final String name) {
        return Practice.getInstance().getRegisterCollections().getArena().stream().filter(arenaManager -> arenaManager.name.equals(name)).findFirst().orElse(null);
    }
    ...
    {
        List<Arena> availableArena = Practice.getInstance().getRegisterCollections().getArena().stream().filter(arenaManager -> arenaManager.getArenaType() == arenaType).collect(Collectors.toList());
