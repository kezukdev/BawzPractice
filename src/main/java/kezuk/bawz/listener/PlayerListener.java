...
public class PlayerListener implements Listener
{
    ...
    public void onPlayerLeft(final PlayerQuitEvent event) {
        ...
        if (PlayerManager.getPlayers().get(event.getPlayer().getUniqueId()).getPlayerStatus().equals(Status.HOST)) {
            if (Practice.getFfaMatchs().get(PlayerManager.getPlayers().get(event.getPlayer().getUniqueId()).getMatchUUID()) != null && Practice.getFfaMatchs().get(PlayerManager.getPlayers().get(event.getPlayer().getUniqueId()).getMatchUUID()).getStatus() != MatchStatus.FINISHED && Practice.getFfaMatchs().containsKey(PlayerManager.getPlayers().get(event.getPlayer().getUniqueId()).getMatchUUID())) {
            	...
            	Practice.getHosts().get(PlayerManager.getPlayers().get(event.getPlayer().getUniqueId()).getMatchUUID()).getMembers().remove(event.getPlayer().getUniqueId());
            }
        }
